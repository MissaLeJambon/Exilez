...
/* Mission System Settings */
	...
	DMS_MissionMarkerWinDot_Type		= "Empty";				// The marker type to show when a mission is completed. Refer to: https://community.bistudio.com/wiki/cfgMarkers
	DMS_MissionMarkerLoseDot_Type		= "Empty";					// The marker type to show when a mission fails. Refer to: https://community.bistudio.com/wiki/cfgMarkers
	DMS_MissionMarkerWinDotTime			= 0;						// How many seconds the "win" mission dot will remain on the map
	DMS_MissionMarkerLoseDotTime		= 0;						// How many seconds the "lose" mission dot will remain on the map
	...
	DMS_CompletedMissionCleanupTime		= 1000;						// Minimum time until mission-spawned buildings and AI are cleaned up
	DMS_CleanUp_PlayerNearLimit			= 20;						// Cleanup of an object is aborted if a player is this many meters close to the object
	DMS_AIVehCleanUpTime				= 200;						// Time until a destroyed AI vehicle is cleaned up.
	/*Mission Cleanup settings*/
	...
	DMS_SpawnZoneNearBlacklist			= 50;						// Missions won't spawn in a position this many meters close to a spawn zone
	...
	DMS_WaterNearBlacklist				= 10;						// Missions won't spawn in a position this many meters close to water
	...
	DMS_MixerNearBlacklist				= 50;						// Missions won't spawn in a position this many meters close to a concrete mixer
	...
	DMS_MinDistFromWestBorder			= 50;						// Missions won't spawn in a position this many meters close to the western map border.
	DMS_MinDistFromEastBorder			= 50;						// Missions won't spawn in a position this many meters close to the easter map border.
	DMS_MinDistFromSouthBorder			= 50;						// Missions won't spawn in a position this many meters close to the southern map border.
	DMS_MinDistFromNorthBorder			= 50;						// Missions won't spawn in a position this many meters close to the northern map border.
...
/* AI Settings */
	...
	DMS_Bandit_Soldier_MoneyGain		= 20;						// The amount of Poptabs gained for killing a bandit soldier
	DMS_Bandit_Soldier_RepGain			= 10;						// The amount of Respect gained for killing a bandit soldier
	DMS_Bandit_Soldier_RankGain			= 15;
	DMS_Bandit_Soldier_SpawnMoney		= 0;						// The amount of Poptabs carried by a bandit soldier

	DMS_Bandit_Static_MoneyGain			= 20;						// The amount of Poptabs gained for killing a bandit static gunner
	DMS_Bandit_Static_RepGain			= 10;						// The amount of Respect gained for killing a bandit static gunner
	DMS_Bandit_Static_RankGain			= 30;
	DMS_Bandit_Static_SpawnMoney		= 0;						// The amount of Poptabs carried by a bandit static gunner

	DMS_Bandit_Vehicle_MoneyGain		= 40;						// The amount of Poptabs gained for killing a bandit vehicle crew member
	...
	DMS_Bandit_Vehicle_SpawnMoney		= 0;						// The amount of Poptabs carried by a bandit vehicle crew member
...
/* DonkeyPunchDMS Custom Side Factions */
	...
	DMS_ai_freezingDistance				= 3000;						// If there are no players within this distance of the leader of an AI group, then the AI group will be "frozen".
	...
	DMS_ai_skill_static					= [["aimingAccuracy",0.15],["aimingShake",0.25],["aimingSpeed",0.30],["spotDistance",0.15],["spotTime",0.30],["courage",1.00],["reloadSpeed",0.90],["commanding",0.70],["general",0.50]];	// Static AI Skills
	DMS_ai_skill_easy					= [["aimingAccuracy",0.15],["aimingShake",0.25],["aimingSpeed",0.30],["spotDistance",0.15],["spotTime",0.30],["courage",1.00],["reloadSpeed",0.90],["commanding",0.70],["general",0.50]];	// Easy
	DMS_ai_skill_moderate				= [["aimingAccuracy",0.15],["aimingShake",0.25],["aimingSpeed",0.30],["spotDistance",0.15],["spotTime",0.30],["courage",1.00],["reloadSpeed",0.90],["commanding",0.70],["general",0.50]];	// Moderate
	DMS_ai_skill_difficult				= [["aimingAccuracy",0.15],["aimingShake",0.25],["aimingSpeed",0.30],["spotDistance",0.15],["spotTime",0.30],["courage",1.00],["reloadSpeed",0.90],["commanding",0.70],["general",0.50]]; 	// Difficult
	DMS_ai_skill_hardcore				= [["aimingAccuracy",0.15],["aimingShake",0.25],["aimingSpeed",0.30],["spotDistance",0.15],["spotTime",0.30],["courage",1.00],["reloadSpeed",0.90],["commanding",0.70],["general",0.50]]; 	// Hardcore
	DMS_ai_skill_random					= ["hardcore","difficult","difficult","moderate","moderate","moderate","moderate","easy","easy","easy","easy","easy"];	// Skill frequencies for "random" AI skills | Default: 10% hardcore, 30% difficult, 40% moderate, and 20% easy
	DMS_ai_skill_randomDifficult		= ["easy","easy","easy","moderate","moderate","difficult"];	// 60% chance for "difficult", 40% chance for "hardcore" AI.
	DMS_ai_skill_randomEasy				= ["moderate","moderate","easy","easy","easy"];					// 60% chance for "easy", 40% chance for "moderate" AI.
	DMS_ai_skill_randomIntermediate		= ["easy","easy","moderate","moderate","moderate"];	// 60% chance for "moderate", 40% chance for "difficult" AI.
	DMS_AI_WP_Radius_easy				= 20;						// Waypoint radius for "easy" AI.
	DMS_AI_WP_Radius_moderate			= 25;						// Waypoint radius for "moderate" AI.
	DMS_AI_WP_Radius_difficult			= 45;						// Waypoint radius for "difficult" AI.
	DMS_AI_WP_Radius_hardcore			= 55;						// Waypoint radius for "hardcore" AI.
	DMS_AI_AimCoef_easy					= 0.25;						// "Custom Aim Coefficient" (weapon sway multiplier) for "easy" AI
	DMS_AI_AimCoef_moderate				= 0.25;						// "Custom Aim Coefficient" (weapon sway multiplier) for "moderate" AI
	DMS_AI_AimCoef_difficult			= 0.25;						// "Custom Aim Coefficient" (weapon sway multiplier) for "difficult" AI
	DMS_AI_AimCoef_hardcore				= 0.25;						// "Custom Aim Coefficient" (weapon sway multiplier) for "hardcore" AI
	...
	DMS_assault_optic_chance			= 65;						// Percentage chance that an Assault Class AI will get an optic
	DMS_assault_bipod_chance			= 15;						// Percentage chance that an Assault Class AI will get a bipod
	DMS_assault_suppressor_chance		= 15;						// Percentage chance that an Assault Class AI will get a suppressor
	...
	DMS_sniper_RandItemCount =			2;							// How many random items to add to the AI's inventory.
