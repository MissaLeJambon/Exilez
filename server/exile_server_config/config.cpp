...
class CfgExileLootServer
{
	...
	class ItemGroups
	{
		...
		*/
        /* UPDATE : REMOVED NVGoggles */
		GuerillaItems[] = {"ItemCompass", "ItemCompass", "ItemCompass", "ItemCompass", "ItemCompass", "Rangefinder", "ItemCompass", "ItemCompass", "ItemCompass", "ItemCompass", "ItemCompass"};
...
class CfgSettings
{
	...
	class Respect
	{
		...
		*/
		/* UPDATE 1 RESPECT FOR 20 pop tabs */
		tradingRespectFactor = 0.15;

		/**
		* Defines the the minimum amount of Respect earned/lost for a kill
		*/
		minRespectTransfer = 150;
	...
	class Events
	{
		...
		*/
		...
		class SupplyBox
		{
			...
			*/
			types[] = {"ConstructionMats", "ConstructionMats","ConstructionMats", "Beer", "Tools", "Food", "RepairParts"};
			...
			class BoxTypes
			{
				...
				class ConstructionMats
				{
					items[] =
					{
						{"Exile_Item_Sand", 15},
						{"Exile_Item_Cement", 10},
						{"Exile_Item_JunkMetal", 5},
						{"Exile_Item_WoodPlank", 10},
						{"Exile_Item_ExtensionCord", 2},
						{"Exile_Item_LightBulb", 2},
						{"Exile_Item_MetalBoard", 1}
					};
				}
