...
SC_minDistanceToPlayer      	= 200;                  	// Minimum distance in metres to the nearest player
...
SC_fastNightsStarts         	= 19;                   	// Start fast nights at this hour (24 hour clock) eg. 18 for 6pm
SC_fastNightsMultiplierNight	= 4;                    	// the time multiplier to use at night (12 = 12x speed)
SC_fastNightsEnds           	= 7;                    	// End fast nights at this hour (24 hour clock) eg. 6 for 6am
SC_fastNightsMultiplierDay  	= 5;                    	// the time multiplier to use during daylight hours (4 = 4x speed)
...
SC_LootCrateItems           	= [
                                    ["Exile_Melee_Axe",0,1],
                                    ["Exile_Item_GloriousKnakworst",0,3],
                                    ["Exile_Item_PlasticBottleFreshWater",0,3],
                                    ["Exile_Item_Beer",0,5],
                                    ["Exile_Item_BaseCameraKit",0,1],
                                    ["Exile_Item_InstaDoc",0,2],
...
SC_VehicleClassToUseRare		=   [
                                    ...
                                    ["Exile_Car_Tempest",1],
									["Exile_Car_Ural_Open_Military",1],
									["Exile_Car_Ural_Covered_Military", 1]
                                ];
...
SC_SurvivorUniforms         	= ["U_I_CombatUniform", "U_I_CombatUniform_tshirt", "U_I_CombatUniform_shortsleeve", "U_O_OfficerUniform_ocamo", "U_O_SpecopsUniform_blk"];
SC_SurvivorVests            	= ["V_BandollierB_blk","V_BandollierB_cbr","V_BandollierB_khk","V_BandollierB_oli"];
SC_SurvivorHeadgear         	= ["H_HelmetIA_camo", "H_HelmetIA", "H_HelmetIA_net", "H_MilCap_dgtl"];
SC_SurvivorWeapon           	= ["arifle_MXC_F","arifle_TRG20_F", "arifle_Mk20C_ACO_F", "arifle_Mk20C_F", "arifle_Mk20C_ACO_pointer_F", "arifle_Mk20_pointer_F", "srifle_EBR_MRCO_LP_BI_F"];
SC_SurvivorWeaponAttachments	= ["acc_flashlight"];
...
SC_SurvivorPistol           	= ["hgun_ACPC2_F", "hgun_ACPC2_snds_F"];
SC_SurvivorPistolAttachments	= [];
SC_SurvivorAssignedItems    	= ["ItemMap","ItemCompass","ItemRadio","ItemWatch"]; // all these items will be added
SC_SurvivorLauncher         	= [];
SC_SurvivorBackpack         	= ["B_AssaultPack_mcamo", "B_FieldPack_ocamo", "B_Carryall_mcamo", "B_Carryall_khk", "B_AssaultPack_khk", "B_Carryall_khk"];
...
SC_BanditVests              	= ["H_Bandanna_khk","H_Watchcap_camo","V_BandollierB_blk","V_BandollierB_cbr","V_BandollierB_khk","V_BandollierB_oli", "V_Chestrig_blk", "V_TacVest_blk"];
SC_BanditHeadgear           	= ["H_Bandanna_khk","H_Shemag_khk","H_Shemag_olive","H_Shemag_olive_hs","H_Shemag_tan","H_ShemagOpen_khk","H_ShemagOpen_tan"];
SC_BanditWeapon             	= ["LMG_Zafir_F","arifle_Katiba_C_F","arifle_Katiba_F","arifle_Katiba_GL_F","arifle_MXC_Black_F","arifle_MXC_F","arifle_TRG20_F","arifle_TRG21_F","arifle_TRG21_GL_F", "Exile_Weapon_SVD", "Exile_Weapon_CZ550", "Exile_Weapon_LeeEnfield", "Exile_Weapon_AK107", "Exile_Weapon_AK107_GL", "Exile_Weapon_AK74", "Exile_Weapon_AK74_GL", "Exile_Weapon_AK47"];
SC_BanditWeaponAttachments  	= ["acc_flashlight"];
SC_BanditMagazines          	= [
    //TRASH & USELESS & FLARES 22% - 44 objects
	//Trash : 24
	"Exile_Item_Magazine01",
...
SC_RandomUniforms           	= ["U_B_GEN_Soldier_F","U_B_GEN_Commander_F"];
SC_RandomVests              	= ["V_TacVest_gen_F"];
SC_RandomHeadgear           	= ["H_Cap_police"];
SC_RandomWeapon             	= ["SMG_05_F", "hgun_PDW2000_F", "SMG_02_F"];
...
SC_RandomPistol             	= ["hgun_Rook40_F", "hgun_P07_F"];
