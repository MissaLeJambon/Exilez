...
private ["_baseObjs", "_num", "_side", "_classname", "_OK", "_pos", "_difficulty", "_AICount", "_group", "_type", "_launcher", "_crate", "_vehClass", "_extraParams", "_vehicle", "_crate_loot_values", "_missionAIUnits", "_missionObjs", "_msgStart", "_msgWIN", "_msgLOSE", "_missionName", "_markers", "_time", "_added", "_cleanup"];
...
// Create Crate
_crate = ["Box_NATO_Wps_F",[_pos,3,120] call DMS_fnc_SelectOffsetPos] call DMS_fnc_SpawnCrate;
...
_vehClass =
	...
	{
		selectRandom DMS_CivilianVehicles
	}
	else
	{
...
_vehicle = [_vehClass,[_pos,3,340] call DMS_fnc_SelectOffsetPos] call DMS_fnc_SpawnNonPersistentVehicle;
...
_missionObjs =
[
	_baseObjs,			// No spawned buildings
	[_vehicle],
